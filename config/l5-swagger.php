...
// Update config based on: https://github.com/DarkaOnLine/L5-Swagger/pull/270#issuecomment-622221340
return [
    'default' => 'v'.config('api.version'),
    'documentations' => [
        'default' => [
            'api' => [
                /*
        ...
        'v1' => [
            ...
            'api' => [
                ...
                */
                ...
                'title' => 'API V1 Swagger Documentation',
            ],
